...
This file is the quick-reference operating contract for image-kotlin. The longer
...
image-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`image`](https://crates.io/crates/image). Upstream Rust is the behavioral oracle while the
