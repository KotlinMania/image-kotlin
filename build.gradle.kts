...
kotlin {
    ...
    swiftExport {
        moduleName = "Image"
        flattenPackage = "io.github.kotlinmania.image"
    }

    android {
        namespace = "io.github.kotlinmania.image"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "image-kotlin", version.toString())

    pom {
        name.set("image-kotlin")
        description.set("Kotlin Multiplatform port of image-rs/image - Imaging library. Provides basic image processing and encoders/decoders for common image formats")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/image-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/image-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/image-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/image-kotlin.git")
        }
    }
}
