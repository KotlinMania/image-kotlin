...
class WebPTest {
    ...
    fun testWebpAddWithOverflowSize() {
        val bytes = byteArrayOf(
            0x52, 0x49, 0x46, 0x46, 0xaf.toByte(), 0x37, 0x80.toByte(), 0x47, 0x57, 0x45, 0x42, 0x50, 0x6c, 0x64,
            0x00, 0x00, 0xff.toByte(), 0xff.toByte(), 0xff.toByte(), 0xff.toByte(), 0xfb.toByte(), 0x7e, 0x73, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x65, 0x65, 0x65, 0x65, 0x65, 0x65,
            0x40, 0xfb.toByte(), 0xff.toByte(), 0xff.toByte(), 0x65, 0x65, 0x65, 0x65, 0x65, 0x65, 0x65, 0x65, 0x65, 0x65,
