...
class DdsTest {
    ...
    fun testDimensionOverflow() {
        ...
        val header =
            byteArrayOf(
                0x44, 0x44, 0x53, 0x20, 0x7C, 0x0, 0x0, 0x0, 0x7, 0x10, 0x8, 0x0, 0xFC.toByte(), 0xFF.toByte(), 0xFF.toByte(),
                0xFF.toByte(), 0xFC.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0x0, 0xC0.toByte(), 0x12, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0,
    ...
    fun testValidDdsDxt1() {
        ...
        header[8] = 0x07; header[9] = 0x10; header[10] = 0x00; header[11] = 0x00
        // Height: 4
        header[12] = 4; header[13] = 0; header[14] = 0; header[15] = 0
        // Width: 4
        header[16] = 4; header[17] = 0; header[18] = 0; header[19] = 0

        // PixelFormat offset: 4 + 72 = 76 (i.e. bytes 76..107)
        // PixelFormat size: 32
        header[76] = 32; header[77] = 0; header[78] = 0; header[79] = 0
        // PixelFormat flags: DDPF_FOURCC = 0x4
        header[80] = 0x04; header[81] = 0; header[82] = 0; header[83] = 0
        // FourCC: "DXT1"
        header[84] = 'D'.code.toByte(); header[85] = 'X'.code.toByte(); header[86] = 'T'.code.toByte(); header[87] = '1'.code.toByte()

        // Caps: DDSCAPS_TEXTURE = 0x1000
        header[108] = 0x00; header[109] = 0x10; header[110] = 0x00; header[111] = 0x00

        // 8 bytes of DXT1 payload at offset 128 (solid white)
        header[128] = 0xFF.toByte(); header[129] = 0xFF.toByte()
        header[130] = 0xFF.toByte(); header[131] = 0xFF.toByte()
